...
<script>
    ...
    function showBiodataAndProceedToSelfie(userData) {
        ...
        // Show biodata in the main area
        document.getElementById('qr-scanner').style.display = 'none';
        document.getElementById('selfie-camera').style.display = 'block';
        document.getElementById('scanner-step').textContent = 'Langkah 2: Ambil Foto Selfie';
        document.getElementById('footer-info').textContent = 'Ambil foto selfie untuk verifikasi absensi';

        // Update scanner body to show biodata temporarily
    ...
    function startSelfieCamera() {
        ...
        .catch(err => {
            ...
            alert('Tidak dapat mengakses kamera depan');
            backToBiodata();
        });
    }
    ...
    function backToQRScanner() {
        ...
        scannerBody.innerHTML = `
            ...
            <div id="selfie-camera" style="display: none;">
                <!-- Selfie camera will be injected when needed -->
            </div>
        `;
    ...
    function initializeQRScanner() {
        Html5Qrcode.getCameras().then(cameras => {
            if (cameras && cameras.length) {
                // Prioritize back camera (usually last in list)
