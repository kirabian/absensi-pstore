...
@elseif (auth()->user()->role == 'user_biasa' || auth()->user()->role == 'leader')
    <!-- TAMPILAN USER BIASA & LEADER DI SINI -->
    <div class="row">
        {{-- KARTU ID BARU --}}
                    ...
                    @elseif(isset($myLeaveToday) && $myLeaveToday)
                        @php
                            ...
                            if ($myLeaveToday->type == 'telat' && $myLeaveToday->start_time) {
                                $timeInfo =
                                    'Datang jam: ' . \Carbon\Carbon::parse($myLeaveToday->start_time)->format('H:i');
                            } else {
                                $end = $myLeaveToday->end_date
                                    ? \Carbon\Carbon::parse($myLeaveToday->end_date)->format('d M')
                                    : '-';
                                $timeInfo = 'Sampai: ' . $end;
                            }
                        @endphp
